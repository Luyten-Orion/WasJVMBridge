...
public class ReflectionModule extends ModuleBase {
    ...
    public List<HostFunction> getFunctions() {
        return List.of(
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_class",
                        FunctionType.of(List.of(ValType.I32, ValType.I32), List.of(ValType.I64)), (inst, args) -> {
                    try {
                 ...
                 */
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_constructor_id",
                        FunctionType.of(List.of(ValType.I64, ValType.I32, ValType.I32), List.of(ValType.I64)),
                        (inst, args) -> {
                            try {
                                ...
                                for (int i = 0; i < count; i++) {
                                    params[i] = kernel.classRegistry.get(
                                            inst.memory().readLong((int) args[1] + (i * 8)));
                                }
                 ...
                 */
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "new_instance",
                        FunctionType.of(
                                List.of(ValType.I64, ValType.I32, ValType.I32),
                                List.of(ValType.I64)
                        ), (inst, args) -> {
                    try {
                        Object res = kernel.invokeConstructorInternal(
                                args[0], (int) args[1], (int) args[2], inst);
                        long id = kernel.handleCounter.getAndIncrement();
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_method_id",
                        FunctionType.of(
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "call_method_void",
                        FunctionType.of(List.of(ValType.I64, ValType.I64, ValType.I32, ValType.I32), List.of()),
                        (inst, args) -> {
                            try {
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "call_method_obj",
                        FunctionType.of(
                                List.of(ValType.I64, ValType.I64, ValType.I32, ValType.I32),
                                List.of(ValType.I64)
                        ), (inst, args) -> {
                    try {
                        Object res = kernel.invokeInternal(
                                args[0], args[1], (int) args[2], (int) args[3], inst);
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_field_id",
                        FunctionType.of(List.of(ValType.I64, ValType.I32, ValType.I32), List.of(ValType.I64)),
                        (inst, args) -> {
                            try {
                                Class<?> clazz = kernel.classRegistry.get(args[0]);
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_field_obj",
                        FunctionType.of(List.of(ValType.I64, ValType.I64), List.of(ValType.I64)), (inst, args) -> {
                    try {
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "set_field_obj",
                        FunctionType.of(List.of(ValType.I64, ValType.I64, ValType.I64), List.of()), (inst, args) -> {
                    try {
                        Object target = kernel.globalInstanceRegistry.get(args[0]);
                        Field f = kernel.fieldRegistry.get(args[1]);
                        kernel.validateMember(f.getDeclaringClass(), target, f.getName());
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "release_instance", FunctionType.of(List.of(ValType.I64), List.of()),
                        (inst, args) -> {
