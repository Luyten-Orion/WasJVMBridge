...
public class StringModule extends ModuleBase {
    ...
    public List<HostFunction> getFunctions() {
        return List.of(
                 ...
                 */
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "create_string",
                ...
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_string_content",
                 ...
                 */
                new HostFunction(
                        WasJVMBridge.NAMESPACE, "get_string_into",
                        FunctionType.of(List.of(ValType.I64, ValType.I32, ValType.I32), List.of(ValType.I32)),
                        (inst, args) -> {
